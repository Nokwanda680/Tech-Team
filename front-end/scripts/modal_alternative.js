...
function create_cards(card){
    ...
    <article class="card" id="card${card.id}" onclick="openModal(${card.id})">
        <div class="card-media" >
          <img src='/front-end/Images/${card.main_img || "No main picture  Available right now"}' alt="Student apartment">
    ...
    <div class="modal" onclick="event.stopPropagation()">
      ...
      <div class="modal-gallery">
        <div class="modal-gallery-main">
          <img src="/front-end/Images/${card.main_img || "image unavailable "}" alt="Main photo" onclick="openModal(card.id)">
        </div>
        <div class="modal-gallery-thumb" color='black'><img src="/front-end/Images/${card.sub_image1 || "Image unavailable"}" alt="Bedroom"></div>
        <div class="modal-gallery-thumb"><img src="/front-end/Images/${card.sub_image2 || "Image unavailable"}" alt="Living area"></div>
        <div class="modal-gallery-thumb"><img src="/front-end/Images/${card.sub_image3 || "Image unavailable"}" alt="Kitchen"></div>
        <div class="modal-gallery-thumb"><img src="/front-end/Images/${card.sub_image4 || "Image unavailable"}" alt="Study area"></div>
      </div>
      <div class="modal-content">
        ...
        <div class="modal-section">
          ...
          <div class="video-preview">
            <video src="/front-end/Images/${card.video || "Video un-available"}" autoplay muted></video>
